...
const newPollController = require('./controllers/poll');
...
//homescreen routine, retrieves polls from database
app.get('/', newPollController.getPolls);
...
app.get('/account/mypolls', newPollController.getPollsByUserID);
